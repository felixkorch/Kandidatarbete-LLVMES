      ...
      m_address(0)
{
    ...
    instructionTable[0x4C] = {&CPU::AddressModeAbsolute, &CPU::OP_JMP,
                              "JMP Abs"};
    instructionTable[0x6C] = {&CPU::AddressModeIndirect, &CPU::OP_JMP,
                              "JMP Indirect"};
    instructionTable[0x20] = {&CPU::AddressModeAbsolute, &CPU::OP_JSR, "JSR"};

    instructionTable[0x24] = {&CPU::AddressModeZeropage, &CPU::OP_BIT,
                              "BIT Zeropage"};
    instructionTable[0x2C] = {&CPU::AddressModeAbsolute, &CPU::OP_BIT,
                              "BIT Abs"};

    instructionTable[0x00] = {&CPU::AddressModeImplied, &CPU::OP_BRK, "BRK"};

    instructionTable[0x69] = {&CPU::AddressModeImmediate, &CPU::OP_ADC,
                              "ADC Imm"};

    instructionTable[0xC9] = {&CPU::AddressModeImmediate, &CPU::OP_CMP,
                              "CMP Imm"};
    instructionTable[0xC5] = {&CPU::AddressModeZeropage, &CPU::OP_CMP,
                              "CMP Zeropage"};
    instructionTable[0xD5] = {&CPU::AddressModeZeropageX, &CPU::OP_CMP,
                              "CMP Zeropage X"};
    instructionTable[0xCD] = {&CPU::AddressModeAbsolute, &CPU::OP_CMP,
                              "CMP Abs"};
    instructionTable[0xDD] = {&CPU::AddressModeAbsoluteX, &CPU::OP_CMP,
                              "CMP Abs X"};
    instructionTable[0xD9] = {&CPU::AddressModeAbsoluteY, &CPU::OP_CMP,
                              "CMP Abs Y"};
    instructionTable[0xC1] = {&CPU::AddressModeIndirectX, &CPU::OP_CMP,
                              "CMP Indirect X"};
    instructionTable[0xD1] = {&CPU::AddressModeIndirectY, &CPU::OP_CMP,
                              "CMP Indirect Y"};
    ...
    instructionTable[0x49] = {&CPU::AddressModeImmediate, &CPU::OP_EOR,
                              "EOR Imm"};
    instructionTable[0x45] = {&CPU::AddressModeZeropage, &CPU::OP_EOR,
                              "EOR Zeropage"};
    instructionTable[0x55] = {&CPU::AddressModeZeropageX, &CPU::OP_EOR,
                              "EOR Zeropage X"};
    instructionTable[0x4D] = {&CPU::AddressModeAbsolute, &CPU::OP_EOR,
                              "EOR Abs"};
    instructionTable[0x5D] = {&CPU::AddressModeAbsoluteX, &CPU::OP_EOR,
                              "EOR Abs X"};
    instructionTable[0x59] = {&CPU::AddressModeAbsoluteY, &CPU::OP_EOR,
                              "EOR Abs Y"};
    instructionTable[0x41] = {&CPU::AddressModeIndirectX, &CPU::OP_EOR,
                              "EOR Indirect X"};
    instructionTable[0x51] = {&CPU::AddressModeIndirectY, &CPU::OP_EOR,
                              "EOR Indirect Y"};

    instructionTable[0xA9] = {&CPU::AddressModeImmediate, &CPU::OP_LDA,
                              "LDA Imm"};
    instructionTable[0xA5] = {&CPU::AddressModeZeropage, &CPU::OP_LDA,
                              "LDA Zeropage"};
    instructionTable[0xB5] = {&CPU::AddressModeZeropageX, &CPU::OP_LDA,
                              "LDA Zeropage X"};
    instructionTable[0xA1] = {&CPU::AddressModeIndirectX, &CPU::OP_LDA,
                              "LDA Indirect X"};
    instructionTable[0xB1] = {&CPU::AddressModeIndirectY, &CPU::OP_LDA,
                              "LDA Indirect Y"};
    instructionTable[0xAD] = {&CPU::AddressModeAbsolute, &CPU::OP_LDA,
                              "LDA Abs"};
    instructionTable[0xBD] = {&CPU::AddressModeAbsoluteX, &CPU::OP_LDA,
                              "LDA Abs X"};
    instructionTable[0xB9] = {&CPU::AddressModeAbsoluteY, &CPU::OP_LDA,
                              "LDA Abs Y"};

    instructionTable[0xA2] = {&CPU::AddressModeImmediate, &CPU::OP_LDX,
                              "LDX Imm"};
    instructionTable[0xA6] = {&CPU::AddressModeZeropage, &CPU::OP_LDX,
                              "LDX Zeropage"};
    instructionTable[0xB6] = {&CPU::AddressModeZeropageY, &CPU::OP_LDX,
                              "LDX Zeropage Y"};
    instructionTable[0xAE] = {&CPU::AddressModeAbsolute, &CPU::OP_LDX,
                              "LDX Abs"};
    instructionTable[0xBE] = {&CPU::AddressModeAbsoluteY, &CPU::OP_LDX,
                              "LDX Abs Y"};

    instructionTable[0xA0] = {&CPU::AddressModeImmediate, &CPU::OP_LDY,
                              "LDY Imm"};
    instructionTable[0xA4] = {&CPU::AddressModeZeropage, &CPU::OP_LDY,
                              "LDY Zeropage"};
    instructionTable[0xB4] = {&CPU::AddressModeZeropageX, &CPU::OP_LDY,
                              "LDY Zeropage X"};
    instructionTable[0xAC] = {&CPU::AddressModeAbsolute, &CPU::OP_LDY,
                              "LDY Abs"};
    instructionTable[0xBC] = {&CPU::AddressModeAbsoluteX, &CPU::OP_LDY,
                              "LDY Abs X"};

    instructionTable[0x4A] = {&CPU::AddressModeAccumulator, &CPU::OP_LSR_ACC,
                              "LSR Acc"};
    instructionTable[0x46] = {&CPU::AddressModeZeropage, &CPU::OP_LSR,
                              "LSR Zeropage"};
    instructionTable[0x56] = {&CPU::AddressModeZeropageX, &CPU::OP_LSR,
                              "LSR Zeropage X"};
    instructionTable[0x4E] = {&CPU::AddressModeAbsolute, &CPU::OP_LSR,
                              "LSR Abs"};
    instructionTable[0x5E] = {&CPU::AddressModeAbsoluteX, &CPU::OP_LSR,
                              "LSR Abs X"};

    instructionTable[0x09] = {&CPU::AddressModeImmediate, &CPU::OP_ORA,
                              "ORA Imm"};
    instructionTable[0x05] = {&CPU::AddressModeZeropage, &CPU::OP_ORA,
                              "ORA Zeropage"};
    instructionTable[0x15] = {&CPU::AddressModeZeropageX, &CPU::OP_ORA,
                              "ORA Zeropage X"};
    instructionTable[0x0D] = {&CPU::AddressModeAbsolute, &CPU::OP_ORA,
                              "ORA Abs"};
    instructionTable[0x1D] = {&CPU::AddressModeAbsoluteX, &CPU::OP_ORA,
                              "ORA Abs X"};
    instructionTable[0x19] = {&CPU::AddressModeAbsoluteY, &CPU::OP_ORA,
                              "ORA Abs Y"};
    instructionTable[0x01] = {&CPU::AddressModeIndirectX, &CPU::OP_ORA,
                              "ORA Indirect X"};
    instructionTable[0x11] = {&CPU::AddressModeIndirectY, &CPU::OP_ORA,
                              "ORA Indirect Y"};
    ...
    instructionTable[0x2A] = {&CPU::AddressModeImplied, &CPU::OP_ROL_ACC,
                              "ROL Acc"};
    instructionTable[0x26] = {&CPU::AddressModeZeropage, &CPU::OP_ROL,
                              "ROL Zeropage"};
    instructionTable[0x36] = {&CPU::AddressModeZeropageX, &CPU::OP_ROL,
                              "ROL Zeropage X"};
    instructionTable[0x2E] = {&CPU::AddressModeAbsolute, &CPU::OP_ROL,
                              "ROL Abs"};
    instructionTable[0x3E] = {&CPU::AddressModeAbsoluteX, &CPU::OP_ROL,
                              "ROL Abs X"};

    instructionTable[0x6A] = {&CPU::AddressModeImplied, &CPU::OP_ROR_ACC,
                              "ROR Acc"};
    instructionTable[0x66] = {&CPU::AddressModeZeropage, &CPU::OP_ROR,
                              "ROR Zeropage"};
    instructionTable[0x76] = {&CPU::AddressModeZeropageX, &CPU::OP_ROR,
                              "ROR Zeropage X"};
    instructionTable[0x6E] = {&CPU::AddressModeAbsolute, &CPU::OP_ROR,
                              "ROR Abs"};
    instructionTable[0x7E] = {&CPU::AddressModeAbsoluteX, &CPU::OP_ROR,
                              "ROR Abs X"};

    instructionTable[0x40] = {&CPU::AddressModeImplied, &CPU::OP_RTI, "RTI"};
    instructionTable[0x60] = {&CPU::AddressModeImplied, &CPU::OP_RTS, "RTS"};

    instructionTable[0xE9] = {&CPU::AddressModeImmediate, &CPU::OP_SBC,
                              "SBC Imm"};
    instructionTable[0xE5] = {&CPU::AddressModeZeropage, &CPU::OP_SBC,
                              "SBC Zeropage"};
    instructionTable[0xF5] = {&CPU::AddressModeZeropageX, &CPU::OP_SBC,
                              "SBC ZeropageX"};
    instructionTable[0xED] = {&CPU::AddressModeAbsolute, &CPU::OP_SBC,
                              "SBC Abs"};
    instructionTable[0xFD] = {&CPU::AddressModeAbsoluteX, &CPU::OP_SBC,
                              "SBC Abs X"};
    instructionTable[0xF9] = {&CPU::AddressModeAbsoluteY, &CPU::OP_SBC,
                              "SBC Abs Y"};
    instructionTable[0xE1] = {&CPU::AddressModeIndirectX, &CPU::OP_SBC,
                              "SBC Indirect X"};
    instructionTable[0xF1] = {&CPU::AddressModeIndirectY, &CPU::OP_SBC,
                              "SBC Indirect Y"};
    ...
    instructionTable[0x85] = {&CPU::AddressModeZeropage, &CPU::OP_STA,
                              "STA Zeropage"};
    instructionTable[0x95] = {&CPU::AddressModeZeropageX, &CPU::OP_STA,
                              "STA Zeropage X"};
    instructionTable[0x8D] = {&CPU::AddressModeAbsolute, &CPU::OP_STA,
                              "STA Abs"};
    instructionTable[0x9D] = {&CPU::AddressModeAbsoluteX, &CPU::OP_STA,
                              "STA Abs X"};
    instructionTable[0x99] = {&CPU::AddressModeAbsoluteY, &CPU::OP_STA,
                              "STA Abs Y"};
    instructionTable[0x81] = {&CPU::AddressModeIndirectX, &CPU::OP_STA,
                              "STA Indirect X"};
    instructionTable[0x91] = {&CPU::AddressModeIndirectY, &CPU::OP_STA,
                              "STA Indirect Y"};

    instructionTable[0x86] = {&CPU::AddressModeZeropage, &CPU::OP_STX,
                              "STX Zeropage"};
    instructionTable[0x96] = {&CPU::AddressModeZeropageY, &CPU::OP_STX,
                              "STX Zeropage Y"};
    instructionTable[0x8E] = {&CPU::AddressModeAbsolute, &CPU::OP_STX,
                              "STX Abs"};

    instructionTable[0x84] = {&CPU::AddressModeZeropage, &CPU::OP_STY,
                              "STY Zeropage"};
    instructionTable[0x94] = {&CPU::AddressModeZeropageX, &CPU::OP_STY,
                              "STY Zeropage X"};
    instructionTable[0x8C] = {&CPU::AddressModeAbsolute, &CPU::OP_STY,
                              "STY Abs"};
    ...
    instructionTable[0x29] = {&CPU::AddressModeImmediate, &CPU::OP_AND,
                              "AND Imm"};
    instructionTable[0x25] = {&CPU::AddressModeZeropage, &CPU::OP_AND,
                              "AND Zeropage"};
    instructionTable[0x35] = {&CPU::AddressModeZeropageX, &CPU::OP_AND,
                              "AND Zeropage X"};
    instructionTable[0x2D] = {&CPU::AddressModeAbsolute, &CPU::OP_AND,
                              "AND Abs"};
    instructionTable[0x3D] = {&CPU::AddressModeAbsoluteX, &CPU::OP_AND,
                              "AND Abs X"};
    instructionTable[0x39] = {&CPU::AddressModeAbsoluteY, &CPU::OP_AND,
                              "AND Abs Y"};
    instructionTable[0x21] = {&CPU::AddressModeIndirectX, &CPU::OP_AND,
                              "AND Indirect X"};
    instructionTable[0x31] = {&CPU::AddressModeIndirectY, &CPU::OP_AND,
                              "AND Indirect Y"};

    instructionTable[0x0A] = {&CPU::AddressModeAccumulator, &CPU::OP_ASL_ACC,
                              "ASL Acc"};
    instructionTable[0x06] = {&CPU::AddressModeZeropage, &CPU::OP_ASL,
                              "ASL Zeropage"};
    instructionTable[0x16] = {&CPU::AddressModeZeropageX, &CPU::OP_ASL,
                              "ASL Zeropage X"};
    instructionTable[0x0E] = {&CPU::AddressModeAbsolute, &CPU::OP_ASL,
                              "ASL Abs"};
    instructionTable[0x1E] = {&CPU::AddressModeAbsoluteX, &CPU::OP_ASL,
                              "ASL Abs X"};
...
void CPU::Step()
{
    ...
    std::cout << "0x" << std::hex << regPC - 1 << ": " << instr.name
              << std::endl;
#endif
...
void CPU::Dump()
{
    std::cout << "Register X: " << (unsigned int)regX << "\n"
...
void CPU::OP_JSR()
{
    std::uint16_t returnAddress =
        regPC - 1;  // TODO: Should be just regPC since we increment in step()?
